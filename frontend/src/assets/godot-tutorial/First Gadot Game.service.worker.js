...
const CACHE_NAME = "First Gadot Game-cache";
const OFFLINE_URL = "First Gadot Game.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["First Gadot Game.html","First Gadot Game.js","First Gadot Game.wasm","First Gadot Game.pck","First Gadot Game.offline.html","First Gadot Game.icon.png","First Gadot Game.apple-touch-icon.png"];
